...
public class ManageExpensePage extends BaseClass{
	...
	ManageExpense mp;
	  ...
	  wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@class='form-control date']")));
	  String expected="21/22/3";
	...
	public void imageHandling() throws InterruptedException {
		lp=new LoginPage(driver);
		 ...
		 mp=new ManageExpense(driver);
			  ...
			  "//src//main//resources//images//Screenshot (2).png"; 
			  ...
			  softAssert.assertEquals(actual,expected,"no match");
